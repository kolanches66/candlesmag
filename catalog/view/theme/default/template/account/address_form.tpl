...
<div id="content-wrapper">
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-sm-9"> <?php echo $content_top; ?>
      <h2 class="pagename"><?php echo $text_edit_address; ?></h2>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
		  ...
		  <div class="">
            ...
            <div class="">
              <select name="country_id" id="input-country" class="textbox">
          ...
          <div class="">
            ...
            <div class="">
              <select name="zone_id" id="input-zone" class="textbox">
              </select>
              <?php if ($error_zone) { ?>
		  ...
		  <div class="">
            ...
            <div class="">
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="textbox" />
              <?php if ($error_city) { ?>
          ...
          <div class="">
            ...
            <div class="">
              <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="textbox" />
          ...
          <div class="">
            ...
            <div class="">
              <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="textbox" />
