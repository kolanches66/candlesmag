  ...
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><strong> <?php echo $text_cart; ?></strong></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>"><strong><i class="fa fa-share"></i> <?php echo $text_checkout; ?></strong></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
