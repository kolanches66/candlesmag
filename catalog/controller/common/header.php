...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['account_password'] = $this->url->link('account/password', '', true);
		$data['account_address'] = $this->url->link('account/address', '', true);
		$data['orders_history'] = $this->url->link('account/order', '', true);
		...
		$data['phone2'] = $this->config->get('config_fax');
		
		// получаем названия и ссылки на статьи (оплата, доставка)
