...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			// удаляем всю сессию, связанную с гостем
	...
	private function validate() {
		...
		// фамилия слишком короткая или слишком длинная
		if ((utf8_strlen(trim($this->request->post['lastname'])) < 1) || (utf8_strlen(trim($this->request->post['lastname'])) > 32)) {
			$this->error['lastname'] = $this->language->get('error_lastname');
		}

		// email слишком длинный и не соответствует маске
		...
		// телефон слишком короткий или слишком длинный
		...
		// пароль слишком короткий или слишком длинный
