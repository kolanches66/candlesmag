		...
		<div class="header-wrapper--right">
			...
			<div class="for-customer">
				<?php if (!$logged) { ?>
					...
					<h4 class="links"><a class="link blue" href="<?php echo $login; ?>">Вход</a>&nbsp;/&nbsp;<a class="link blue" href="<?php echo $register; ?>">регистрация</a></h4>
				<?php }
				else { ?>
					<center><a href="<?=$orders_history?>">История заказов</a>&nbsp;|&nbsp;<a href="<?=$account_edit?>">Изменить данные</a><br><a 
					   href="<?=$account_address?>">Адрес доставки</a>&nbsp;|&nbsp;<a href="<?=$logout?>">Выход</a></center>
				<?php } ?>
			</div>
		</div>
	</div>
